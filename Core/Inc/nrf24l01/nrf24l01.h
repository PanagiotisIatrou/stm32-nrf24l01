 ...
 * @param csn_port The CSN GPIO port connected to the device.
 * @param csn_pin The CSN GPIO pin connected to the device.
 * @param ce_port The CE GPIO port connected to the device.
